		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
						...
						<h1>Head Office</h1></br> 
						
						<p>
						<strong>SSPJIIMS (KANDIVALI):</strong></br></br> 
	
						SHREE S.P.JAIN INTERNATIONAL INSTITUTE OF MANAGEMENT STUDIES<strong>   </strong> </br> 
						B-3, 2nd.FLOOR, NEMI-KRISHNA BLDG., OPP-BAJAJ SCHOOL,</br>
						JETHWA NAGAR, NEAR STATION, KANDIVALI-WEST,MUMBAI - 400067.</br>
						 
						<strong>HELP LINE -</br> Tel   :-</strong> +91 - 9619333960</br>
									<strong>Email :-</strong> <a href="mailto:info@sspjiims.org">info@sspjiims.org</a>   
						</p>

						</br></br>
						
						<h1>Branch Office</h1></br> 
						
						<p>
						<strong>SSPJIIMS (BHAYANDER):</strong></br></br> 
						B-205, 2nd.FLOOR, OSTWAL SHOPPING CENTER, OPP-RAILWAY STATION,</br>
						BHAYANDER - EAST,THANE-401105.</br></br>
