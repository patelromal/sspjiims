...
<ul class="sf-menu">
					...
					<li><a href="aboutus.jsp">About Us</a>
						<ul>
							...
							<li><a href="certi.jsp">ACCREDITATION,</br>RECOGNITION & CERTIFICATIONS</a></li>
					...
					<li><a href="#">Our Courses</a>
						<ul>
							<s:iterator value="courseList">
								<li><s:url action="courseDetails" id="courseURL1" method="courseDetails">
									<s:param name="paramCourseId">
									<s:property value="key"/></s:param>
								 </s:url> 
								 <s:a href="%{courseURL1}"><s:property value="value"/></s:a>
								</li>
							</s:iterator>
						</ul>
					</li>
					...
					<li><a href="#">ADMISSION</a>
						<ul>
							...
							<li><a href="paymentform.jsp">ONLINE FEES PAYMENT</a></li>
